...
<html lang="en">
  ...
  <style>
body {
  background-image: url('/Courier-Management-System-main/login/assets/red-delivery car.jpg');
...
<br>
<form action="/Courier-Management-System-main/login/delivery_status.php" method="post">
