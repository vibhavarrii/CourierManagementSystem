...
<html lang="en">
  ...
  <style>
body {
  background-image: url('/Courier-Management-System-main/login/assets/ecom.jpg');
...
<h1 style="color:darkblue; text-align:center">Enter the staff details to update </h1>
<form action="/Courier-Management-System-main/login/staff_update.php" method="post">
    <br>
<div class="mb-3">
<div class="mb-3">
